 ...
 */
export declare function resolveWidevineCdmDir(binaryPath: string): string | null;
/**
 ...
 */
export declare function seedWidevineHint(userDataDir: string, binaryPath: string): void;
//# sourceMappingURL=widevine.d.ts.map