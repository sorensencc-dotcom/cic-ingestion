...
export function createCacheCommand() {
    const cacheCommand = new Command('cache').description('Cache management and monitoring');
        ...
        try {
            ...
            if (!opts.force) {
                ...
                await new Promise((resolve) => {
                    rl.question(`⚠️  Delete ${summary.eligible_docs} documents? (y/N) `, (answer) => {
                        rl.close();
    ...
    cacheCommand
        ...
        try {
            ...
            const displayStatus = () => {
                ...
                console.log(`Tokens:      ${summary.total_cache_read_tokens_saved.toLocaleString()}\n`);
...
//# sourceMappingURL=cic-cli-cache.js.map