...
import { RoadmapContext } from './RoadmapProposalEngine.js';
...
export declare class AutonomyService {
     ...
     */
    analyzeArchivalBatch(docId: string, batchContent: string, analysisType: 'findings' | 'gaps' | 'patterns'): Promise<import("./AutonomyPromptCacheAdapter.js").DocumentAnalysisResult>;
    /**
