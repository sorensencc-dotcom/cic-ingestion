                ...
                switch (signal.type) {
                    case 'drift':
                        if (this.thresholds.DRIFT_CRITICAL > 0.7) {
                            this.adjustThreshold('DRIFT_CRITICAL', this.thresholds.DRIFT_CRITICAL + 0.05, `Proposal ${proposal.id} failed; increased drift threshold`);
                        }
                        break;
                    case 'instability':
                ...
                switch (signal.type) {
                    case 'drift':
                        if (this.thresholds.DRIFT_CRITICAL < 0.75) {
                            this.adjustThreshold('DRIFT_CRITICAL', this.thresholds.DRIFT_CRITICAL - 0.02, `Proposal ${proposal.id} succeeded; decreased drift threshold`);
                        }
                        break;
                    case 'instability':
