...
import { GovernanceCouncil, NewProposal, VoteInput } from '../../../../services/cic-governance/src/services/GovernanceCouncil';
...
export function createGovernanceRouter(): Router {
   ...
   * Response: GovernancePacket
   */
  router.post('/votes', async (req: Request, res: Response, next: NextFunction) => {
    try {
